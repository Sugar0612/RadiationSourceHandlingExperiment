...
public class SelfTestAction : ActionBase
{
    ...
    [ClientRpc] public override void RpcStartAction_5(GameColliderPackage gamePkg) { CoreAction.Get().StartAction_5(gamePkg); }
    ...
    [ClientRpc] public override void RpcStartAction_6(GameColliderPackage gamePkg) { CoreAction.Get().StartAction_6(gamePkg); }
    ...
    [ClientRpc] public override void RpcStartAction_7(GameColliderPackage gamePkg) { CoreAction.Get().StartAction_7(gamePkg); }
    ...
    [ClientRpc] public override void RpcStartAction_8(GameColliderPackage gamePkg) { CoreAction.Get().StartAction_8(gamePkg); }

    [ClientRpc]
    public override void RpcTaskAction_8(GameColliderPackage gamePkg)
    {
        RadiationSource[] radArray = FindObjectsOfType<RadiationSource>();
        foreach (RadiationSource rad in radArray)
        {
    ...
    [ClientRpc] public override void RpcStartAction_9(GameColliderPackage gamePkg) { CoreAction.Get().StartAction_9(gamePkg); }
    ...
    [ClientRpc] public override void RpcStartAction_10(GameColliderPackage gamePkg) { CoreAction.Get().StartAction_10(gamePkg); }

    [ClientRpc]
    public override void RpcTaskAction_10(GameColliderPackage gamePkg)
    {
        RadiationSource[] radArray = FindObjectsOfType<RadiationSource>();
        foreach (RadiationSource rad in radArray)
        {
    ...
    [ClientRpc] public override void RpcStartAction_11(GameColliderPackage gamePkg) { CoreAction.Get().StartAction_11(gamePkg); }
    ...
    [ClientRpc] public override void RpcStartAction_12(GameColliderPackage gamePkg) { CoreAction.Get().StartAction_12(gamePkg); }
    ...
    [ClientRpc] public override void RpcStartAction_13(GameColliderPackage gamePkg) { CoreAction.Get().StartAction_13(gamePkg); }

    [ClientRpc] public override void RpcTaskAction_13(GameColliderPackage gamePkg) { CoreAction.Get().TaskAction_13(gamePkg); }
